...
//３．データ登録SQL作成
$sql = "INSERT INTO gs_kikaku(co_name,a_name,co_tel,co_mail,co_addnum,co_add,co_type,co_genre,co_pass)VALUES(:co_name,:a_name,:co_tel,:co_mail,:co_addnum,:co_add,:co_type,:co_genre,:co_pass)";
